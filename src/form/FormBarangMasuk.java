...
public class FormBarangMasuk extends javax.swing.JDialog {
    ...
    try {
        ...
        String insertQuery = "INSERT INTO transaksi (IDSupplier, IDBarang, JenisTransaksi, TanggalTransaksi, JumlahBarang, TotalHarga) "
                + "VALUES (" + IDSupplier + ", " + KodeBarang + ", 'masuk', NOW(), " + jSpinner1.getValue() + ", "+ totalHarga + ")";
...
private void updateTransaction(int transactionID) {
    try {
        ...
        String updateStockQuery = "UPDATE barang SET JumlahStok = JumlahStok - (SELECT JumlahBarang FROM transaksi WHERE IDTransaksi = " + transactionID + ") + " + quantity +
...
private void deleteTransaction(int transactionID) {
    ...
    private void initComponents() {
        ...
        label1.setText("Kelola Barang Masuk");
        ...
        label1.getAccessibleContext().setAccessibleName("Kelola Barang Masuk");
